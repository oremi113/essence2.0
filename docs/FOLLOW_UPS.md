...
| 2026-07-14 triage | 1×P2 · 6×P3 · 1×P4 | **8 new per-file items** — voice-create stale-timeout loses a paid voice (P2); `/save` superseded-promotion, `getSubscriptionStatus` error→none, failed-attempts burn the voice cap, saved-message cap race, onboarding zero-row writes, `billing_period` portal desync (P3); `/save` audio-orphan on insert failure (P4). See [`docs/follow-ups/INDEX.md`](follow-ups/INDEX.md). | 📁 per-file |
