...
**Resolved 2026-09-21.** Written 2026-07-12 on `fix/step6-cost-control-wedge` (PR #112) and
salvaged onto `main` today — #112 also carried an FU-93 fix that #132 superseded, so only this
half was lifted rather than forcing a conflicting rebase. The `retry_audio` branch now (1)
